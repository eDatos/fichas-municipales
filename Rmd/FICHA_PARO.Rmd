...
# Num_Paro_num <- df_piramide %>% filter(mun == municipio_actual$municipio & periodo == mes_actual$Periodo & gredad == "TOTAL" & sexo == "AMBOS SEXOS") %>%
#                              subset(select = "valor") %>%  as.numeric()
# Num_Paro_Canarias <- df_piramide %>% filter(mun == "CANARIAS" & periodo == mes_actual$Periodo & gredad == "TOTAL" & sexo == "AMBOS SEXOS") %>%
#                              subset(select = "valor") %>% as.numeric()

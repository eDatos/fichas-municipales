...
Num_Paro_num <- df_lv %>% select(valor) %>% as.numeric()
Num_Paro <- df_lv %>% select(valor) %>% as.numeric() %>% format(big.mark = ".", decimal.mark = ",")
...
Num_Paro_Isla <- df_piramide %>% filter(mun == municipio_actual$isla & code == mes_actual$code & Ind == "ABSOLUTE") %>% select(Valor) %>% as.numeric()
Num_Paro_Canarias <- df_piramide %>% filter(mun == "CANARIAS" & code == mes_actual$code & Ind == "ABSOLUTE") %>% select(Valor) %>% as.numeric()

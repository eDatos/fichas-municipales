...
```{r funciones mapa}
get_map_box_before = function(column_number) {
  return(sprintf('<div class="row" style="margin-top:10px;"><div class="column-%s"><div class="indicator-map map-canarias"><div class="image">', column_number))
}
...
mapa_Canarias_plot
```
`r get_map_box_after(paste0(rk_isla, 'º'), 'Canarias', num_mun_canarias, paste0(percent_canarias, '%'))`

`r if_else(Plazas_Hoteles == "NA" & Plazas_extrahoteleros == "NA", get_map_box_before(2), get_map_box_before(3))`
```{r}
mapa_isla_plot
```
`r get_map_box_after(paste0(rk_canarias, 'º'),  municipio_actual$isla, num_mun_isla, paste0(percent_isla, '%'))`

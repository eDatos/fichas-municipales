...
df_plot <- df_plot %>%
  transform(hovertext = paste0(
    ...
    municipio_actual$provincia,": ", trimws(format(valor_P, big.mark = ".", decimal.mark = ",")), " votos",
...
g_congreso_mun <- ggplot(data = df_plot, aes(y = name_partido, label = label, name = NULL, text = hovertext)) +

              ...
              for(i in 1:data_congreso[["metadata"]][["dimensions"]][["dimension"]][["dimensionValues"]][["total"]][2]) {
                ...
                if(params$año == "2019_ABRIL"){
                  df_congreso <- data.frame(
                    ...
                    candidatura = rep(data_congreso[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[2]][["code"]],
                                      each = length(data_congreso[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[3]][["code"]])),
                    medida = data_congreso[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[3]][["code"]],
                    valor = c(unlist(strsplit(data_congreso[["data"]][["observations"]], split = " | ", fixed = TRUE)), rep(NA, dR)))
...
df_congreso_P <- df_congreso %>% 
  spread(medida, valor) %>% filter(!is.na(VOTOS_VALIDOS_CANDIDATURA)) %>% 
  select(mun, candidatura, valor_P = VOTOS_VALIDOS_CANDIDATURA, porcentaje_P = PORCENTAJE_VOTOS_CANDIDATURA) %>% 

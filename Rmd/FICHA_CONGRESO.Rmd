...
df_plot <- df_plot %>%
  transform(name_partido = paste0(name_partido, "<br>(", trimws(format(round(porcentaje, 1), big.mark = ".", decimal.mark = ",", nsmall = 1)), "%)"))
...
df_plot <- df_plot %>% transform(hovertext = paste0(
  ...
  "<br>", municipio_actual$isla,": ", format(valor_P, big.mark = ".", decimal.mark = ","), " votos",
...
if(Variacion_Porcentual == "NA"){
  cat(paste0(
    "<div class='column-2-ind'>", get_indicator2('Tasa de</br>abstención', Tasa_abstencion, './img/percent-blue.png'), "</div><div class='column-2-ind'>", get_indicator2('Electores', Num_Electores, './img/percent-blue.png'), "</div>"))
}else{
  cat(paste0(
    "<div class='column-3-ind'>", get_indicator2('Tasa de</br>variación', paste0(Variacion_Porcentual, '%'), Imagen_Variacion), "</div><div class='column-3-ind'>", get_indicator2('Tasa de</br>abstención', Tasa_abstencion, './img/percent-blue.png'), "</div><div class='column-3-ind'>", get_indicator2('Electores', Num_Electores, './img/percent-blue.png'), "</div>"))
}
```
</div>

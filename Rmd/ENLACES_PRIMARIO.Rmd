...
if(Variacion_Porcentual != "NA"){
  ...
  if(df_lv$tasa == 0){
    diferencia <- superficie_cultivada_num - df$valor[which(df$mun == params$id_municipio & df$año == params$año-1)]
...
sup_leñosos <- sup_leñosos_num %>% format(big.mark = ".", decimal.mark = ",")
...
percent_leñosos <- round(sup_leñosos_num / superficie_cultivada_num * 100, 1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
percent_leñosos_C <- round(sup_leñosos_C / sup_Canarias_total * 100, 1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
...
df_leñosos_mun <- df_leñosos_mun %>%
  mutate(porcentaje = df_leñosos_mun$valor / sup_leñosos_num * 100,
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "http://www.gobiernodecanarias.org/istac/estadisticas/sectorprimario/",
        "Sector primario")`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=SUPERFICIE_CULTIVO#visualization/table",
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=SUPERFICIE_CULTIVO_SECANO#visualization/table",
        "Superficie cultivada. Secano")`
  `r get_indicator_mod_last(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=SUPERFICIE_CULTIVO_REGADIO#visualization/table",
        "Superficie cultivada. Regadío")`
...
<div class="row">
  `r get_indicator_mod_first(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:fc6d7c86-8956-4d3b-91f0-50ec367baf57&uripub=urn:uuid:ef5f2e5c-e2c4-4c1d-b5ed-c20fe946ce6f",
        "Superficie de cultivos herbáceos según cultivos y sistemas de cultivo")`
  `r get_indicator_mod_last(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:803af13a-04f6-4789-8e78-48f5fdff64a7&uripub=urn:uuid:ef5f2e5c-e2c4-4c1d-b5ed-c20fe946ce6f",
        "Superficie en plantación regular y árboles diseminados de cultivos leñosos según cultivos y sistemas de cultivo")`
...
<div class="column highlight">
<div class="row">
<div class='indicator5'><div class='indicator-content'><p class='value'>`r sup_leñosos` ha</p><hr class='separator'><p class='label'>Superficie cultivada</p></div></div>
</div>
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=E01008B_000002&version=~latest#visualization/table",
        "Número de explotaciones según especies")`
  `r get_indicator_mod_inter(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=E01008B_000001&version=~latest#visualization/table",
        "Efectivos de ganado según especies")`
  `r get_indicator_mod_inter(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=GANADO_BOVINO#visualization/table",
        "Cabezas de ganado. Bovino")`
  `r get_indicator_mod_inter(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=GANADO_CAPRINO#visualization/table",
        "Cabezas de ganado. Caprino")`
  `r get_indicator_mod_inter(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=GANADO_OVINO#visualization/table",
        "Cabezas de ganado. Ovino")`
  `r get_indicator_mod_inter(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=GANADO_PORCINO#visualization/table",
        "Cabezas de ganado. Porcino")`
  `r get_indicator_mod_last(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=E01008B_000010&version=~latest#visualization/table",
        "Efectivos de ganado apícola según sistemas productivos")`

...
df_GM_pt <- df_GM_pt %>%
  mutate(paquete = recode(paquete, "TOTAL" = "Paquete turístico")) %>%
  mutate(paquete = recode(paquete, "Con servicios extras" = "Paquete con servicios extras")) %>%
  mutate(paquete = recode(paquete, "Sin servicios extras" = "Paquete sin servicios extras"))
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/menu.do?uripub=urn:uuid:70b2796b-2f02-435c-9f0a-7588612bb733",
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:f8bc6e2a-b082-4c72-93f6-81d2c847306f",
        "Gastos medios según sexos y grupos de edades")`

<div class="column-modulo-right">
<div class="highlight-modulo">
<div class="linechart-placeholder">
<h2 style="color: #005980; margin: 0;">`r Gasto_por_turista` €</h2>
<div class="linechart">
  `r g_line`
</div>
...
if(Variacion_Porcentual == "NA"){
  cat(paste0(
    '<div class="column-2-ind">', get_indicator2("Mujeres", paste0(Gasto_por_turista_M, " €"), "./img/female.png"), '</div><div class="column-2-ind">', get_indicator2("Hombres", paste0(Gasto_por_turista_H, " €"), "./img/male.png"), '</div>'))
}else{
  cat(paste0(
    '<div class="column-3-ind">', get_indicator2("Tasa de<br/>variación", paste0(Variacion_Porcentual, "%"), Imagen_Variacion), '</div><div class="column-3-ind">', get_indicator2("Mujeres", paste0(Gasto_por_turista_M, " €"), "./img/female.png"), '</div><div class="column-3-ind">', get_indicator2("Hombres", paste0(Gasto_por_turista_H, " €"), "./img/male.png"), '</div>'))
}
```
</div>
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:db6d00b1-143f-4010-98bb-05f34f7b034b",
        "Gastos medios según tipos de alojamiento")`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:cce945de-a4d1-412c-a8c5-49875db31243",
        "Gastos medios, incluyendo desgloses del gasto, según países de residencia")`
  `r get_indicator_mod_last(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:2604207e-c2b6-4b85-ac05-9ba0dd9b6ce4",
        "Gastos medios según niveles de ingresos")`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        ...
        "Gastos medios según sexos y grupos de edades")`
  `r get_indicator_mod_last(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:175c51b8-b490-49a8-a934-539ba7ac9595",
        "Gastos medios según situación laboral")`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:82620c58-b532-4cf8-8567-92a962b00a25",
        "Gastos medios según nivel educativo")`
  `r get_indicator_mod_inter(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:691d144f-4fb5-44d2-9caf-f092df5b40f8",
        "Gastos medios por turista del paquete turístico")`
  `r get_indicator_mod_last(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:39d02f9a-5b79-43ed-a57b-a158960c67e1",
        "Gastos medios según noches pernoctadas")`

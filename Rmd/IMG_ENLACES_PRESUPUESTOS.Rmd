...
df_gastos_programas_mun <- df_gastos_programas %>% filter(ano == params$ano & mun == params$id_municipio) %>% arrange(desc(valor)) %>% select(name_programa, valor)
...
<div class="linechart" style="height: 290px;">
  `r g_line`
</div>
...
<div class="column-modulo-right">
<div class="highlight-modulo" style="padding: 22px 15px;">

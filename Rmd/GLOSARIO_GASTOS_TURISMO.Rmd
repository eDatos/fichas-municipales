...
<div class="row highlight card-columns-3">
  ...
  `r get_indicator_met_("Tasa de variación", "Medición que estudia el incremento o disminución porcentual que experimenta el gasto medio por turista entre dos momentos determinados. Los periodos comprendidos a la hora de realizar cálculos de tasas de variación suelen ser de un año o por trimestre.")`
</div>

...
df_defunciones_mun <- df_defunciones %>% filter(año == params$año & mun == municipio_actual$municipio)
...
df_nacimientos_mun <- df_nacimientos %>% filter(año == params$año & mun == municipio_actual$municipio)
...
df_crec_veg_mun <- df_crec_veg %>% filter(año == params$año & mun == municipio_actual$municipio)
...
Num_lugar_Canarias_C <- df_lugar %>% filter(mun == "CANARIAS" & lugar == "CANARIAS" & año == params$año & sexo =="AMBOS SEXOS") %>% subset(select = "valor") %>% as.numeric
Num_lugar_RestoEspaña_C <- df_lugar %>% filter(mun == "CANARIAS" & lugar == "RESTO DE ESPAÑA" & año == params$año & sexo =="AMBOS SEXOS") %>% subset(select = "valor") %>% as.numeric
Num_lugar_OtroPais_C <- df_lugar %>% filter(mun == "CANARIAS" & lugar == "OTRO PAÍS" & año == params$año & sexo =="AMBOS SEXOS") %>% subset(select = "valor") %>% as.numeric
...
df_nacionalidad_mun_sexo <- df_nacionalidad_mun_sexo %>% transform(hovertext = paste0(
  hovertext = paste0(
    ifelse(sexo == "Hombres", paste0("<b>", trimws(nacionalidad),"</b><br>"), ""),
    "<br><b>", sexo, "</b>",
    "<br>", format(abs(valor), big.mark = ".", decimal.mark = ","),
    " (", format(round(abs(porcentaje)*100, 1), big.mark = ".", decimal.mark = ","), "%)"
    )
...
g_nacionalidad_mun_sexo <- ggplot(df_nacionalidad_mun_sexo, aes(x = valor, y = nacionalidad, fill = sexo, group = sexo, text = hovertext)) +
  ...
  theme(axis.line = element_blank(),
        ...
        panel.background = element_rect(fill = "white"),
        legend.position = "none") +
  scale_x_continuous(labels = function(x){format(abs(x), big.mark = '.', decimal.mark = ",")},
...
```{r, results='asis'}
if(max(df_nacimientos$año) == params$año-1 | max(df_defunciones$año) == params$año-1 | max(df_crec_veg$año) == params$año-1 | max(df_id_depen$año) == params$año-1){
  cat(paste0("</div></div><div class='indicator-title' style='width: 100% !important; margin-top: 15px; padding: 5px;'><h3>Lugares de nacimiento</h3></div><div class='row highlight' style='width: 100% !important; margin-top: 10px; padding-top: 10px;'><div class='column' style='margin-top: 10px;'><div class='progress-bar-container'><div class='progress-bar-1' style='width:", porc_lugar_Canarias, "%'></div><div class='progress-bar-2' style='width:", porc_lugar_RestoEspaña, "%'></div><div class='progress-bar-3' style='width:", porc_lugar_OtroPais, "%'></div></div><div class='progressbar-legend-container'><div class='progressbar-legend'><div class='progress-bar-1'></div><div class='sp-content'>Canarias<br/>", format(porc_lugar_Canarias_l, big.mark = ".", decimal.mark = ",", nsmall = 1), "%</div></div><div class='progressbar-legend'><div class='progress-bar-2'></div><div class='sp-content'>Resto de España<br/>", format(porc_lugar_RestoEspaña_l, big.mark = ".", decimal.mark = ",", nsmall = 1), "%</div></div><div class='progressbar-legend'><div class='progress-bar-3'></div><div class='sp-content'>Extranjero<br/>", format(porc_lugar_OtroPais_l, big.mark = ".", decimal.mark = ",", nsmall = 1), "%</div></div></div></div><div class='column' style='margin-top: 10px;'><div class='row'><p style='margin: -10px 16px;'>Canarias</p><div class='progress-bar-container'><div class='progress-bar-1-C' style='width:", porc_lugar_Canarias_C, "%'></div><div class='progress-bar-2-C' style='width:", porc_lugar_RestoEspaña_C, "%'></div><div class='progress-bar-3-C' style='width:", porc_lugar_OtroPais_C, "%'></div></div><div class='progressbar-legend-container'><div class='progressbar-legend'><div class='progress-bar-1-C'></div><div class='sp-content'>Canarias<br/>", format(porc_lugar_Canarias_l_C, big.mark = ".", decimal.mark = ",", nsmall = 1), "%</div></div><div class='progressbar-legend'><div class='progress-bar-2-C'></div><div class='sp-content'>Resto de España<br/>", format(porc_lugar_RestoEspaña_l_C, big.mark = ".", decimal.mark = ",", nsmall = 1), "%</div></div><div class='progressbar-legend'><div class='progress-bar-3-C'></div><div class='sp-content'>Extranjero<br/>", format(porc_lugar_OtroPais_l_C, big.mark = ".", decimal.mark = ",", nsmall = 1), "%</div></div></div></div></div></div>"))
}else{
  cat(paste0("<div class='indicator-title' style='width: 100% !important; margin-top: 15px; padding: 5px;'><h3>Lugares de nacimiento</h3></div><div class='highlight' style='width: 100% !important; margin-top: 10px; padding-top: 10px;'><div class='progress-bar-container'><div class='progress-bar-1' style='width:", porc_lugar_Canarias, "%'></div><div class='progress-bar-2' style='width:", porc_lugar_RestoEspaña, "%'></div><div class='progress-bar-3' style='width:", porc_lugar_OtroPais, "%'></div></div><div class='progressbar-legend-container'><div class='progressbar-legend'><div class='progress-bar-1'></div><div class='sp-content'>Canarias<br/>", format(porc_lugar_Canarias_l, big.mark = ".", decimal.mark = ",", nsmall = 1), "%</div></div><div class='progressbar-legend'><div class='progress-bar-2'></div><div class='sp-content'>Resto de España<br/>", format(porc_lugar_RestoEspaña_l, big.mark = ".", decimal.mark = ",", nsmall = 1), "%</div></div><div class='progressbar-legend'><div class='progress-bar-3'></div><div class='sp-content'>Extranjero<br/>", format(porc_lugar_OtroPais_l, big.mark = ".", decimal.mark = ",", nsmall = 1), "%</div></div></div></div></div></div>"))
}
```

...
params:
  ...
  url.municipales_electores: http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?accion=jsonMtd&uuidConsulta=7b167ec2-df8a-405a-bc12-d5e10f1ed6f7
output:
  html_document:
    df_print: paged
...
data_electores <- fromJSON(params$url.municipales_electores)
...
convocatoria <- convocatoria %>% 
  transform(convocatoria_formatted = paste0(unlist(lapply(strsplit(convocatoria, " "), '[[', 2))),
            url = paste0("url.municipales_", substring(code, 0,4)))

...
for (i in 1:nrow(df_representantes_)) {
  cat(paste0(
    "<div class='row-repr'><div class='column'><div class='representantes'><p class='partido'>", df_representantes_$name_partido_siglas[i], "</p></div></div><div class='column'><div class='representantes'>"))

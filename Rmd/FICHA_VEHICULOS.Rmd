...
df_combustibles_otros <- df_combustibles_otros %>%
  mutate(porcentaje = df_combustibles_otros$valor / sum(df_combustibles_otros$valor) * 100)
...
porc_1 <- df_combustibles_otros$porcentaje[1]
porc_2 <- df_combustibles_otros$porcentaje[2]
porc_3 <- df_combustibles_otros$porcentaje[3]
porc_4 <- df_combustibles_otros$porcentaje[4]
porc_o <- 100 - porc_1 - porc_2 - porc_3 - porc_4

porc_1_l <- round(porc_1, 1) %>% as.numeric
porc_2_l <- round(porc_2, 1) %>% as.numeric
porc_3_l <- round(porc_3, 1) %>% as.numeric
porc_4_l <- round(porc_4, 1) %>% as.numeric
porc_o_l <- round(porc_o, 1) %>% as.numeric
```
...
<div class="legend-vertical-container" style="margin-top: 60px;">
  <div class="progressbar-legend"><div class="progress-bar-blue1"></div><div class="sp-content">Gasolina (`r format(porc_gasolina_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%)</div></div>
  <div class="progressbar-legend"><div class="progress-bar-blue3"></div><div class="sp-content">Diesel (`r format(porc_diesel_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%)</div></div>
  <div class="progressbar-legend"><div class="progress-bar-blue5"></div><div class="sp-content">Eléctrico (`r format(porc_electrico_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%)</div></div>
  <div class="progressbar-legend"><div class="progress-bar-blue6"></div><div class="sp-content">Resto de tipos de combustible (`r format(porc_otros_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%)</div></div>
</div>
</div>

<div class="column">
<div class="progress-bar-container">
  <div class="progress-bar-blue1" style="width:`r porc_1`%"></div>
  <div class="progress-bar-blue3" style="width:`r porc_2`%"></div>
  <div class="progress-bar-blue4" style="width:`r porc_3`%"></div>
  <div class="progress-bar-blue5" style="width:`r porc_4`%"></div>
  <div class="progress-bar-blue6" style="width:`r porc_o`%"></div>
</div>

<div class="legend-vertical-container" style="margin-top: 60px;">
  <div class="progressbar-legend"><div class="progress-bar-blue1"></div><div class="sp-content">`r tipo_1` (`r format(porc_1_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%)</div></div>
  <div class="progressbar-legend"><div class="progress-bar-blue3"></div><div class="sp-content">`r tipo_2` (`r format(porc_2_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%)</div></div>
  <div class="progressbar-legend"><div class="progress-bar-blue4"></div><div class="sp-content">`r tipo_3` (`r format(porc_3_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%)</div></div>
  <div class="progressbar-legend"><div class="progress-bar-blue5"></div><div class="sp-content">`r tipo_4` (`r format(porc_4_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%)</div></div>
  <div class="progressbar-legend"><div class="progress-bar-blue6"></div><div class="sp-content">Resto de tipos de combustible (`r format(porc_o_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%)</div></div>
</div>
</div>

...
if(Variacion_Porcentual_Veh_Parque == "NA"){
  cat(paste0(
    "<div class='column-3-ind'>", get_indicator2(paste0('Turismos</br></p><p class="label" style="color: #999;">', paste0(Percent_Tur_Parque, '%')), Num_Tur_Parque, './img/family.png'), "</div><div class='column-3-ind'>", get_indicator2("Matriculaciones", Num_Matriculaciones, "./img/female.png"), "</div><div class='column-3-ind'>", get_indicator2("Matriculaciones<br>de turismos", Num_Matr_turismos, "./img/male.png"), "</div>"))
}else{
  cat(paste0(

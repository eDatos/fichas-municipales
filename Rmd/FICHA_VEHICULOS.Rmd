...
df_ranking <- df_u %>%
  ...
  filter(mes == mes_actual$code, id != "ES70", medida == "ABSOLUTE" & !is.na(valor)) %>%
  left_join(df_CL_AREA_mun, by = "id") %>% 
  arrange(desc(valor))
...
<div class="highlight" style="width: 100% !important; padding-top: 5px;">

<div class="piramide" style="height: 260px">
  `r g_vehiculos`
</div>

<div class="progressbar-legend-container" style="margin: 10px;">
  <div class="progressbar-legend">
  <div class="progress-bar-C-a">|</div><div class="sp-content">Canarias</div></div>
</div>
</div>

<div class="indicator-title-row" style="margin-top: 15px;">
...
<div class="column highlight" style="padding-top: 10px;">
<div class="piramide" style="height: 401px">
  `r g_matr_tipos`
</div>

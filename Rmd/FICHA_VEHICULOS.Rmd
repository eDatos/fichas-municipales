...
porc_electrico_C <- df_combustibles_C$porcentaje[which(df_combustibles_C$combustible == "Eléctrico")]
porc_otros_C <- 100 - porc_gasolina_C - porc_diesel_C - porc_electrico_C
porc_gasolina_l_C <- round(porc_gasolina_C, 1) %>% as.numeric
porc_diesel_l_C <- round(porc_diesel_C, 1) %>% as.numeric
porc_electrico_l_C <- round(porc_electrico_C, 1) %>% as.numeric
porc_otros_l_C <- round(porc_otros_C, 1) %>% as.numeric
```
...
df_matr_tipos$periodo <- factor(df_matr_tipos$periodo, levels=data_matr_tipos[["categories"]][["codes"]][[3]],
                                labels=paste0(substring(data_matr_tipos[["categories"]][["codes"]][[3]], 0,4), "-", substring(data_matr_tipos[["categories"]][["codes"]][[3]], 5,7)))
...
df_matr_tipos <- df_matr_tipos %>% mutate(veh = recode(veh, "  Vehículos mixtos adaptables" = "  Vehículos mixtos<br>adaptables"),
                                          veh = recode(veh, "  Otros automóviles" = "  Otros<br>automóviles"),
                                          veh = recode(veh, " CICLOMOTORES" = " Ciclomotores"),
                                          veh = recode(veh, " VEHICULOS ESPECIALES" = " Vehículos<br>especiales"),
                                          veh = recode(veh, " REMOLQUES Y SEMIRREMOLQUES" = " Remolques y<br>semirremolques"),
                                          veh = recode(veh, "  " = ""),
                                          )
...
g_matr_tipos <- ggplotly(g_matr_tipos, tooltip = c("text")) %>%
  ...
  config(displaylogo = FALSE,  modeBarButtons = list(list("zoom2d"),list("pan2d"),list("resetScale2d"),list("toImage"))) %>%
  style(hoverinfo = "skip", traces = c((nrow(df_matr_tipos_plot)/2+1):24))
```
...
if(Variacion_Porcentual_Veh_Parque == "NA"){
  cat(paste0(
    "<div class='column-3'>", get_indicator2(paste0('Turismos</br></p><p class="label" style="color: #999;">', paste0(Percent_Tur_Parque, '%')), Num_Tur_Parque, './img/family.png'), "</div><div class='column-3'>", get_indicator2("Matriculaciones", Num_Matriculaciones, "./img/female.png"), "</div><div class='column-3'>", get_indicator2("Matriculaciones<br>de turismos", Num_Matr_turismos, "./img/male.png"), "</div>"))
}else{
  cat(paste0(
    "<div class='column-4'>", get_indicator2('Tasa de</br>variación', paste0(Variacion_Porcentual_Veh_Parque, '%'), Imagen_Variacion), "</div><div class='column-4'>", get_indicator2(paste0('Turismos</br></p><p class="label" style="color: #999;">', paste0(Percent_Tur_Parque, '%')), Num_Tur_Parque, './img/family.png'), "</div><div class='column-4'>", get_indicator2("Matriculaciones", Num_Matriculaciones, "./img/female.png"), "</div><div class='column-4'>", get_indicator2("Matriculaciones<br>de turismos", Num_Matr_turismos, "./img/male.png"), "</div>"))
}
```
</div>
...
<div class='row highlight' style='width: 100% !important; margin-top: 10px; padding-top: 10px;'>
<div class='column' style='margin-top: 10px;'>
<div class='progress-bar-container'>
  <div class="progress-bar-blue1" style="width:`r porc_gasolina`%"></div>
  <div class="progress-bar-blue3" style="width:`r porc_diesel`%"></div>
  <div class="progress-bar-blue5" style="width:`r porc_electrico`%"></div>
  <div class="progress-bar-blue6" style="width:`r porc_otros`%"></div>
</div>
<div class='progressbar-legend-container'>
  <div class='progressbar-legend'><div class='progress-bar-blue1'></div><div class='sp-content'>Gasolina<br>`r format(porc_gasolina_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-blue3'></div><div class='sp-content'>Diesel<br>`r format(porc_diesel_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-blue5'></div><div class='sp-content'>Eléctrico<br>`r format(porc_electrico_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-blue6'></div><div class='sp-content'>Otros<br>`r format(porc_otros_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
</div>
</div>

<div class='column' style='margin-top: 10px;'>
<div class='row'><p style='margin: -10px 16px;'>Canarias</p>
</div>
<div class='progress-bar-container'>
  <div class='progress-bar-grey1' style='width:`r porc_gasolina_C`%'></div>
  <div class='progress-bar-grey3' style='width:`r porc_diesel_C`%'></div>
  <div class='progress-bar-grey5' style='width:`r porc_otros_C`%'></div>
  <div class='progress-bar-grey7' style='width:`r porc_otros_C`%'></div>
</div>
<div class='progressbar-legend-container'>
  <div class='progressbar-legend'><div class='progress-bar-grey1'></div><div class='sp-content'>Gasolina<br/>`r format(porc_gasolina_l_C, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-grey3'></div><div class='sp-content'>Diesel<br/>`r format(porc_diesel_l_C, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-grey5'></div><div class='sp-content'>Eléctrico<br/>`r format(porc_electrico_l_C, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div>
  <div class='progressbar-legend'><div class='progress-bar-grey7'></div><div class='sp-content'>Otros<br/>`r format(porc_otros_l_C, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div>
</div>
</div>
</div>
</div>

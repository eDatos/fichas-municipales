...
g_line <- ggplot(data = df, 
  ...
  scale_x_discrete(breaks = function(x) {paste0(substr(min_code, 0, 4):params$año,"-01")}, labels = function(x){substr(x, 0, 4)}) +
...
df_vehiculos_plot <- df_vehiculos_plot %>% filter(valor != 0)

if(nrow(df_vehiculos_plot)/2 == 7){
  col <- c("#D5EDFA", "#8CD2EA", "#2CBCE2", "#00A6DC", "#008BD0", "#0072A2", "#005980")
  }else if(nrow(df_vehiculos_plot)/2 == 6){
    col <- c("#8CD2EA", "#2CBCE2", "#00A6DC", "#008BD0", "#0072A2", "#005980")
    }else if(nrow(df_vehiculos_plot)/2 == 5){
      col <- c("#8CD2EA", "#2CBCE2", "#008BD0", "#0072A2", "#005980")
      }else if(nrow(df_vehiculos_plot)/2 == 4){
        col <- c("#8CD2EA", "#2CBCE2", "#008BD0", "#005980")
        }else if(nrow(df_vehiculos_plot)/2 == 3){
          col <- c("#8CD2EA", "#008BD0", "#005980")
          }else if(nrow(df_vehiculos_plot)/2 == 2){
            col <- c("#8CD2EA", "#005980")
          }

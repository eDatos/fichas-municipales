...
porc_gasolina_diesel <- df_combustibles_mun$porcentaje[which(df_combustibles_mun$combustible == "Gasolina")] + df_combustibles_mun$porcentaje[which(df_combustibles_mun$combustible == "Diésel")]
...
if(Variacion_Porcentual_Veh_Parque == "NA"){
  cat(paste0(
    "<div class='column-3-ind'>", get_indicator2(paste0('Turismos</br></p><p class="label" style="color: #999;">', paste0(Percent_Tur_Parque, '%')), Num_Tur_Parque, './img/family.png'), "</div><div class='column-3-ind'>", get_indicator2("Gasolina<br>+ diesel", porc_gasolina_diesel_l, "./img/female.png"), "</div><div class='column-3-ind'>", get_indicator2("Eléctricos", porc_electrico_l, "./img/male.png"), "</div>"))
}else{
  cat(paste0(

...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "https://www3.gobiernodecanarias.org/istac/elecciones/#/",
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        "https://www3.gobiernodecanarias.org/istac/elecciones/#/evolucion-electoral/ES70?tipoEleccion=parlamento_europeo",
        "Participación electoral en Canarias. Parlamento Europeo")`
  `r get_indicator_mod_last(
        "https://www3.gobiernodecanarias.org/istac/elecciones/#/proceso-electoral/ES70/PARLAMENTO_EUROPEO_2019/visualization/table",
        "Resultados de elecciones al Parlamento Europeo")`

...
ind_turistas <- df %>% filter(id == params$id_municipio & año == params$año)
...
if(Variacion_Porcentual != "NA"){
  if(ind_turistas$tasa == 0){
    diferencia <- Num_Turistas_num - df$valor[which(df$id == params$id_municipio & df$año == params$año-1)]
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/menu.do?uripub=urn:uuid:69b157fd-faf6-4647-ae6c-80f1851458ca",
        "Encuesta sobre el Gasto Turístico")`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:af70dfe5-761e-4152-9150-44eb5b791d12",
        "Turistas según grupos de edades y sexos por países de residencia")`
  `r get_indicator_mod_inter(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:ebca047d-0dfa-478c-9f51-22f024a3224d",
        "Estancia media según niveles de ingresos")`
  `r get_indicator_mod_last(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:b3db018f-7faa-42cc-831a-6e888cd098ea&uripub=urn:uuid:69b157fd-faf6-4647-ae6c-80f1851458ca",
        "Turistas según el propósito principal del viaje por tipos de alojamiento")`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        ...
        "Turistas según grupos de edades y sexos por países de residencia")`
  `r get_indicator_mod_inter(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:cdfb02f6-1cab-4aff-8c90-eb1e9fefe4e9",
        "Turistas según nivel educativo por países de residencia")`
  `r get_indicator_mod_last(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:90982f6e-54fb-4884-9643-7a22a027bd89",
        "Turistas según situación laboral por tipos de alojamiento")`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:02e4c070-5658-4fc3-a004-94119c107895&uripub=urn:uuid:69b157fd-faf6-4647-ae6c-80f1851458ca",
        "Turistas según la motivación principal para sus vacaciones por tipos de alojamiento")`
  `r get_indicator_mod_last(
        "http://www.gobiernodecanarias.org/istac/jaxi-istac/tabla.do?uripx=urn:uuid:910996fb-2e2f-4d16-86b8-1e9ceb539514",
        "Turistas según niveles de ingresos por países de residencia")`

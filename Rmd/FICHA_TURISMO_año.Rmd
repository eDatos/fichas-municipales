...
g_turismo_aloj <- ggplotly(g_turismo_aloj, tooltip = c("text")) %>%
  layout(hoverlabel = "", hovermode = 'y unified', margin = list(l = 0, r = 0, b = 0)) %>%
  config(displaylogo = FALSE, modeBarButtons = list(list("zoom2d"),list("pan2d"),list("resetScale2d"),list("toImage"))) %>%
...
<div class="row">
<div class="column highlight">
<div class="piramide" style="height: 160px; margin-bottom: 20px;">
  `r g_turismo_aloj`
</div>
<div class="progressbar-legend-container">
...
<div class="progressbar-legend-container">
  ...
  <div class='progressbar-legend'><div class='progress-bar-2'></div><div class='sp-content'>Conocer las islas<br>`r format(porc_Turistas_explorar_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3'></div><div class='sp-content'>Otros<br>`r format(porc_Turistas_otros_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
</div>
...
<div class="progressbar-legend-container">
  ...
  <div class='progressbar-legend'><div class='progress-bar-2-C'></div><div class='sp-content'>Conocer las islas<br>`r format(porc_Turistas_explorar_C_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3-C'></div><div class='sp-content'>Otros<br>`r format(porc_Turistas_otros_C_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
</div>
</div>
...
<div class="progressbar-legend-container">
  <div class='progressbar-legend'><div class='progress-bar-1'></div><div class='sp-content'>Ninguna<br>`r format(porc_Turistas_0_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-2'></div><div class='sp-content'>De 1 a 2<br>`r format(porc_Turistas_1_2_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3'></div><div class='sp-content'>Más de 3<br>`r format(porc_Turistas_3_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
</div>
...
<div class="progressbar-legend-container">
  <div class='progressbar-legend'><div class='progress-bar-1-C'></div><div class='sp-content'>Ninguna<br>`r format(porc_Turistas_0_C_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-2-C'></div><div class='sp-content'>De 1 a 2<br>`r format(porc_Turistas_1_2_C_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3-C'></div><div class='sp-content'>Más de 3<br>`r format(porc_Turistas_3_C_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
</div>
</div>

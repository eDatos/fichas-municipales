...
df_turismo_visitas_C <- df_turismo_visitas_C %>% mutate(porcentaje = df_turismo_visitas_C$valor/ num_Canarias_total * 100)

porc_Turistas_0_C <- df_turismo_visitas_C$porcentaje[which(df_turismo_visitas_C$N_visitas == "Ninguna")]
porc_Turistas_1_2_C <- df_turismo_visitas_C$porcentaje[which(df_turismo_visitas_C$N_visitas == "Una o dos visitas")]
porc_Turistas_3_C <- 100 - df_turismo_visitas_C$porcentaje[which(df_turismo_visitas_C$N_visitas == "Ninguna")] - df_turismo_visitas_C$porcentaje[which(df_turismo_visitas_C$N_visitas == "Una o dos visitas")]
porc_Turistas_0_C_l <- round(porc_Turistas_0_C, 1) %>% as.numeric
porc_Turistas_1_2_C_l <- round(porc_Turistas_1_2_C, 1) %>% as.numeric
porc_Turistas_3_C_l <- round(porc_Turistas_3_C, 1) %>% as.numeric

df_turismo_visitas <- df_turismo_visitas %>%
  filter(N_visitas != "TOTAL" & tipo == "TOTAL" & mun == municipio_actual$municipio & periodo == params$año) %>% 
  select(c(N_visitas, valor))
df_turismo_visitas <- df_turismo_visitas %>% mutate(porcentaje = df_turismo_visitas$valor/ Num_Turistas_num * 100)

porc_Turistas_0 <- df_turismo_visitas$porcentaje[which(df_turismo_visitas$N_visitas == "Ninguna")]
porc_Turistas_1_2 <- df_turismo_visitas$porcentaje[which(df_turismo_visitas$N_visitas == "Una o dos visitas")]
porc_Turistas_3 <- 100 - df_turismo_visitas$porcentaje[which(df_turismo_visitas$N_visitas == "Ninguna")] - df_turismo_visitas$porcentaje[which(df_turismo_visitas$N_visitas == "Una o dos visitas")]
porc_Turistas_0_l <- round(porc_Turistas_0, 1) %>% as.numeric
porc_Turistas_1_2_l <- round(porc_Turistas_1_2, 1) %>% as.numeric
porc_Turistas_3_l <- round(porc_Turistas_3, 1) %>% as.numeric
```
...
df_turismo_educacion$estudios <- factor(df_turismo_educacion$estudios, levels=turismo_educacion[["categories"]][["codes"]][[1]], 
                                        labels=c("TOTAL", "Sin estudios<br>o primarios", "Secundarios", "Superiores"))
...
df_turismo_motiv$motiv <- factor(df_turismo_motiv$motiv, levels=turismo_motiv[["categories"]][["codes"]][[1]], labels=c("TOTAL", "Descansar", "Explorar o<br>conocer las islas", "Otros motivos"))
...
df_turismo_motiv_C <- df_turismo_motiv %>%
  ...
  select(c(motiv, valor))
df_turismo_motiv_C <- df_turismo_motiv_C %>% mutate(porcentaje = df_turismo_motiv_C$valor/ num_Canarias_total * 100)

porc_Turistas_descansar_C <- df_turismo_motiv_C$porcentaje[which(df_turismo_motiv_C$motiv == "Descansar")]
porc_Turistas_explorar_C <- df_turismo_motiv_C$porcentaje[which(df_turismo_motiv_C$motiv == "Explorar o<br>conocer las islas")]
porc_Turistas_otros_C <- 100 - df_turismo_motiv_C$porcentaje[which(df_turismo_motiv_C$motiv == "Descansar")] - df_turismo_motiv_C$porcentaje[which(df_turismo_motiv_C$motiv == "Explorar o<br>conocer las islas")]
...
df_turismo_motiv <- df_turismo_motiv %>%
  ...
  select(c(motiv, valor))
df_turismo_motiv <- df_turismo_motiv %>% mutate(porcentaje = df_turismo_motiv$valor/ Num_Turistas_num * 100)

porc_Turistas_descansar <- df_turismo_motiv$porcentaje[which(df_turismo_motiv$motiv == "Descansar")]
porc_Turistas_explorar <- df_turismo_motiv$porcentaje[which(df_turismo_motiv$motiv == "Explorar o<br>conocer las islas")]
porc_Turistas_otros <- 100 - df_turismo_motiv$porcentaje[which(df_turismo_motiv$motiv == "Descansar")] - df_turismo_motiv$porcentaje[which(df_turismo_motiv$motiv == "Explorar o<br>conocer las islas")]
...
<div class="column highlight" style="padding: 15px">
...
<div class="row">
<p style="margin: 9px 16px -10px;">Canarias</p>
...
<div class="row">
<div class="column highlight" style="padding: 25px 10px;">
<div class="piramide" style="height: 190px">
  `r g_turismo_aloj`
</div>
<div class="progressbar-legend-container">
...
<div class="column highlight" style="padding: 15px">
<div class="progress-bar-container">
  <div class="progress-bar-1" style="width:`r porc_Turistas_descansar`%"></div>
  <div class="progress-bar-2" style="width:`r porc_Turistas_explorar`%"></div>
  <div class="progress-bar-3" style="width:`r porc_Turistas_otros`%"></div>
</div>

<div class="progressbar-legend-container">
  <div class='progressbar-legend'><div class='progress-bar-1'></div><div class='sp-content'>Descansar<br>`r format(porc_Turistas_descansar_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-2'></div><div class='sp-content'>Explorar o<br>conocer las islas<br>`r format(porc_Turistas_explorar_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3'></div><div class='sp-content'>Otros motivos<br>`r format(porc_Turistas_otros_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
</div>

<div class="row">
<p style="margin: 15px 16px -10px;">Canarias</p>

<div class="progress-bar-container" style="height: 20px;">
  <div class="progress-bar-1-C" style="width:`r porc_Turistas_descansar_C`%"></div>
  <div class="progress-bar-2-C" style="width:`r porc_Turistas_explorar_C`%"></div>
  <div class="progress-bar-3-C" style="width:`r porc_Turistas_otros_C`%"></div>
</div>

<div class="progressbar-legend-container">
  <div class='progressbar-legend'><div class='progress-bar-1-C'></div><div class='sp-content'>Descansar<br>`r format(porc_Turistas_descansar_C_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-2-C'></div><div class='sp-content'>Explorar o<br>conocer las islas<br>`r format(porc_Turistas_explorar_C_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3-C'></div><div class='sp-content'>Otros motivos<br>`r format(porc_Turistas_otros_C_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
</div>
</div>
...
<div class="row">
<div class="column highlight" style="padding: 35px 10px 10px;">
...
<div class="progress-bar-container">
  <div class="progress-bar-1" style="width:`r porc_Turistas_0`%"></div>
  <div class="progress-bar-2" style="width:`r porc_Turistas_1_2`%"></div>
  <div class="progress-bar-3" style="width:`r porc_Turistas_3`%"></div>
</div>

<div class="progressbar-legend-container">
  <div class='progressbar-legend'><div class='progress-bar-1'></div><div class='sp-content'>0<br>`r format(porc_Turistas_0_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-2'></div><div class='sp-content'>1 - 2<br>`r format(porc_Turistas_1_2_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3'></div><div class='sp-content'>&ge; 3<br>`r format(porc_Turistas_3_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
</div>
...
<div class="progress-bar-container" style="height: 20px;">
  <div class="progress-bar-1-C" style="width:`r porc_Turistas_0_C`%"></div>
  <div class="progress-bar-2-C" style="width:`r porc_Turistas_1_2_C`%"></div>
  <div class="progress-bar-3-C" style="width:`r porc_Turistas_3_C`%"></div>
</div>

<div class="progressbar-legend-container">
  <div class='progressbar-legend'><div class='progress-bar-1-C'></div><div class='sp-content'>0<br>`r format(porc_Turistas_0_C_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-2-C'></div><div class='sp-content'>1 - 2<br>`r format(porc_Turistas_1_2_C_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3-C'></div><div class='sp-content'>&ge; 3<br>`r format(porc_Turistas_3_C_l, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
</div>
</div>

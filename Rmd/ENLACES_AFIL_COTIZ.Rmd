...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/collection.html?resourceType=collection&agencyId=ISTAC&resourceId=E58015B_000001",
        "Estadística de Afiliación a la Seguridad Social según lugar de cotización"
        )`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=AFILIACIONES#visualization/table",
        "Afiliaciones a la Seguridad Social. Lugar de cotización"
        )`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=AFILIACIONES_MUJERES#visualization/table",
        "Afiliaciones a la Seguridad Social. Mujeres")`
  `r get_indicator_mod_last(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=AFILIACIONES_HOMBRES#visualization/table",
        "Afiliaciones a la Seguridad Social. Hombres")`
...
<div class="row">
  `r get_indicator_mod_first(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=E58015B_000015&version=~latest#visualization/table",
        "Afiliaciones según sexos y grupos de edad")`
  `r get_indicator_mod_last(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=E58015B_000001&version=~latest&multidatasetId=ISTAC:E58015B_000001#visualization/table",
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=E58015B_000009&version=~latest#visualization/table",

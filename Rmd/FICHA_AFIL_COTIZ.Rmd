...
df_ae_C <- df_ae_C %>%
  mutate(ae = recode(ae, "Agricultura, ganadería, silvicultura y pesca" = "Agricultura"),
         ae = recode(ae, "Industrias extractivas" = "Industria"),
         ae = recode(ae, "Industria de la alimentación, bebidas y tabaco" = "Industria"),
         ae = recode(ae, "Industria textil, confección de prendas de vestir, industria del cuero y del calzado" = "Industria"),
         ae = recode(ae, "Industria de la madera, papel y artes gráficas" = "Industria"),
         ae = recode(ae, "Coquerías y refino de petróleo" = "Industria"),
         ae = recode(ae, "Industria química" = "Industria"),
         ae = recode(ae, "Fabricación de productos farmacéuticos" = "Industria"),
         ae = recode(ae, "Fabricación de productos de caucho y plásticos y otros productos minerales no metálicos" = "Industria"),
         ae = recode(ae, "Fabricación de metales básicos y de productos metálicos, excepto maquinaria y equipo" = "Industria"),
         ae = recode(ae, "Fabricación de productos informáticos, electrónicos y ópticos" = "Industria"),
         ae = recode(ae, "Fabricación de material y equipo eléctrico" = "Industria"),
         ae = recode(ae, "Fabricación de maquinaria y equipo n.c.o.p." = "Industria"),
         ae = recode(ae, "Fabricación de material de transporte" = "Industria"),
         ae = recode(ae, "Fabricación de muebles; otras industrias manufactureras; reparación e instalación de maquinaria y equipo" = "Industria"),
         ae = recode(ae, "Suministro de energía eléctrica, gas, vapor y aire acondicionado" = "Industria"),
         ae = recode(ae, "Suministro de agua, actividades de saneamiento, gestión de residuos y descontaminación" = "Industria"),
         ae = recode(ae, "Comercio al por mayor y al por menor; reparación de vehículos de motor y motocicletas" = "Comercio"),
         ae = recode(ae, "Transporte y almacenamiento" = "Resto de servicios"),
         ae = recode(ae, "Actividades de edición, audiovisuales y de programación y emisión de radio y televisión" = "Resto de servicios"),
         ae = recode(ae, "Telecomunicaciones" = "Resto de servicios"),
         ae = recode(ae, "Programación, consultoría y otras actividades relacionadas con la informática; servicios de información" = "Resto de servicios"),
         ae = recode(ae, "Actividades financieras y de seguros" = "Resto de servicios"),
         ae = recode(ae, "Actividades inmobiliarias" = "Resto de servicios"),
         ae = recode(ae, "Actividades jurídicas y de contabilidad; actividades de las sedes centrales; actividades de consultoría de gestión empresarial; servicios técnicos de arquitectura e ingeniería; ensayos y análisis técnicos" = "Resto de servicios"),
         ae = recode(ae, "Investigación y desarrollo" = "Resto de servicios"),
         ae = recode(ae, "Publicidad y estudios de mercado; otras actividades profesionales, científicas y técnicas; actividades veterinarias" = "Resto de servicios"),
         ae = recode(ae, "Actividades administrativas y servicios auxiliares" = "Resto de servicios"),
         ae = recode(ae, "Administración pública y defensa; seguridad social obligatoria" = "Resto de servicios"),
         ae = recode(ae, "Educación" = "Resto de servicios"),
         ae = recode(ae, "Actividades sanitarias" = "Resto de servicios"),
         ae = recode(ae, "Actividades de servicios sociales" = "Resto de servicios"),
         ae = recode(ae, "Actividades artísticas, recreativas y de entretenimiento" = "Resto de servicios"),
         ae = recode(ae, "Otros servicios" = "Resto de servicios"),
         ae = recode(ae, "Actividades de los hogares como empleadores de personal doméstico; actividades de los hogares como productores de bienes y servicios para uso propio" = "Resto de servicios"),
         ae = recode(ae, "Actividades de organizaciones y organismos extraterritoriales" = "Resto de servicios"),
         )
...
df_ae <- df_ae %>%
  mutate(ae = recode(ae, "Agricultura, ganadería, silvicultura y pesca" = "Agricultura"),
         ae = recode(ae, "Industrias extractivas" = "Industria"),
         ae = recode(ae, "Industria manufacturera" = "Industria"),
         ae = recode(ae, "Suministro de energía eléctrica, gas, vapor y aire acondicionado" = "Industria"),
         ae = recode(ae, "Suministro de agua, actividades de saneamiento, gestión de residuos y descontaminación" = "Industria"),
         ae = recode(ae, "Comercio al por mayor y al por menor; reparación de vehículos de motor y motocicletas" = "Comercio"),
         ae = recode(ae, "Transporte y almacenamiento" = "Resto de servicios"),
         ae = recode(ae, "Información y comunicaciones" = "Resto de servicios"),
         ae = recode(ae, "Actividades financieras y de seguros" = "Resto de servicios"),
         ae = recode(ae, "Actividades inmobiliarias" = "Resto de servicios"),
         ae = recode(ae, "Actividades profesionales, científicas y técnicas" = "Resto de servicios"),
         ae = recode(ae, "Actividades administrativas y servicios auxiliares" = "Resto de servicios"),
         ae = recode(ae, "Administración pública y defensa; seguridad social obligatoria" = "Resto de servicios"),
         ae = recode(ae, "Educación" = "Resto de servicios"),
         ae = recode(ae, "Actividades sanitarias y de servicios sociales" = "Resto de servicios"),
         ae = recode(ae, "Actividades artísticas, recreativas y de entretenimiento" = "Resto de servicios"),
         ae = recode(ae, "Otros servicios" = "Resto de servicios"),
         ae = recode(ae, "Actividades de los hogares como empleadores y productores de bienes y servicios para uso propio" = "Resto de servicios"),
         ae = recode(ae, "Actividades de organizaciones y organismos extraterritoriales" = "Resto de servicios"),
         )
...
<h2 style="color: #666; margin: 0;">Afiliaciones según el lugar de cotización</h2>
<hr>

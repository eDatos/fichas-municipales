...
leyenda.template <- "<div class='serie-placeholder serie-placeholder-%s'><div class='sp-bullet' style='background-color: %s'></div><div class='sp-content'><span class='sp-municipio'>%s</span><br/>Personas afiliadas: <span class='sp-habitantes'>%s</span><br/>Tasa de variación: <span class='sp-tasa'>%s&percnt;</span></div></div>"
leyenda.content <- "<span class='sp-municipio'>%s</span><br/>Personas afiliadas: <span class='sp-habitantes'>%s</span><br/>Tasa de variación: <span class='sp-tasa'>%s&percnt;</span>"
...
template <- "<div class='serie-placeholder serie-placeholder-%s'><div class='sp-bullet' style='background-color: %s'></div><div class='sp-content'><span class='sp-municipio'>%s</span><br/>Personas afiliadas: <span class='sp-habitantes'>%s</span><br/>Tasa de variación: <span class='sp-tasa'>%s&percnt;</span></div></div>"
...
if(Variacion_Porcentual_Afil == "NA"){
  ...
  cat(paste0(
    '<div class="column-4">', get_indicator2("Tasa de</br>variación", paste0(Variacion_Porcentual_Afil, "%"), Imagen_Variacion), '</div><div class="column-4">', get_indicator2("Edad</br>media", edad_media, "./img/family.png"), '</div><div class="column-4">', get_indicator2(paste0("Mujeres</p><p class='label' style='color: #999;'>", Num_Afil_M), paste0(Percent_Mujeres, "%"), "./img/female.png"), '</div><div class="column-4">', get_indicator2(paste0("Hombres</p><p class='label' style='color: #999;'>", Num_Afil_H), paste0(Percent_Hombres, "%"), "./img/male.png"), '</div>'))
}
```
</div>
...
<div class="progressbar-legend-container">
  <div class='progressbar-legend'><div class='progress-bar-1'></div><div class='sp-content'>Asalariados</br>`r format(Peso_afil_asal, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3'></div><div class='sp-content'>Autónomos</br>`r format(Peso_afil_auton, big.mark = ".", decimal.mark = ",", nsmall = 1)`%</div></div>
</div>
</div>
</div>
<div class="row" style="margin-top: 10px;">

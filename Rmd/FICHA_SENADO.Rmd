...
df_otros <- df_senado_mun %>% filter(substring(candidatura, 0,1) == "P" & candidatura %notin% df_plot_$candidatura)
...
df_plot_I_ <- df_senado_I %>% filter(substring(candidatura, 0,1) == "P" & candidatura %in% df_plot$candidatura) %>% arrange(valor_I)

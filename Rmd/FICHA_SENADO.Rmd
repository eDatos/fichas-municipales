...
dR <- length(rep(data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[1]][["code"]],
...
if(params$convocatoria %in% c("2019_NOVIEMBRE", "2019_ABRIL", 2016, 2008, 2004, 2000)){
  df_senado <- data.frame(
    ...
    valor = c(unlist(strsplit(data_senado[["data"]][["observations"]], split = " | ", fixed = TRUE)), rep(NA, dR)))
...
df_plot$name_partido <- ordered(df_plot$name_partido, levels = df_plot$name_partido[nrow(df_plot_I):1])

...
params:
  ...
  url.senado_2008: https://datos.canarias.es/api/estadisticas/statistical-resources/v1.0/datasets/ISTAC/C00010A_000019/~latest.json?dim=MEDIDAS:VOTOS_VALIDOS_CANDIDATURA|PORCENTAJE_VOTOS_CANDIDATURA:TERRITORIO:ES704|35003|35007|35014|35015|35017|35030|ES705|35001|35002|35005|35006|35008|35009|35011|35012|35013|35016|35019|35020|35021|35022|35023|35025|35026|35027|35031|35032|35033|ES708|35004|35010|35018|35024|35028|35029|35034|ES703|38013|38048|38901|ES706|38002|38003|38021|38036|38049|38050|ES707|38007|38008|38009|38014|38016|38024|38027|38029|38030|38033|38037|38045|38047|38053|ES709|38001|38004|38005|38006|38010|38011|38012|38015|38017|38018|38019|38020|38022|38023|38025|38026|38028|38031|38032|38034|38035|38038|38039|38040|38041|38042|38043|38044|38046|38051|38052&lang=es
  url.senado_2004: https://datos.canarias.es/api/estadisticas/statistical-resources/v1.0/datasets/ISTAC/C00010A_000020/~latest.json?dim=MEDIDAS:VOTOS_VALIDOS_CANDIDATURA|PORCENTAJE_VOTOS_CANDIDATURA:TERRITORIO:ES704|35003|35007|35014|35015|35017|35030|ES705|35001|35002|35005|35006|35008|35009|35011|35012|35013|35016|35019|35020|35021|35022|35023|35025|35026|35027|35031|35032|35033|ES708|35004|35010|35018|35024|35028|35029|35034|ES703|38013|38048|ES706|38002|38003|38021|38036|38049|38050|ES707|38007|38008|38009|38014|38016|38024|38027|38029|38030|38033|38037|38045|38047|38053|ES709|38001|38004|38005|38006|38010|38011|38012|38015|38017|38018|38019|38020|38022|38023|38025|38026|38028|38031|38032|38034|38035|38038|38039|38040|38041|38042|38043|38044|38046|38051|38052&lang=es
  url.senado_2000: https://datos.canarias.es/api/estadisticas/statistical-resources/v1.0/datasets/ISTAC/C00010A_000022/~latest.json?dim=MEDIDAS:VOTOS_VALIDOS_CANDIDATURA|PORCENTAJE_VOTOS_CANDIDATURA:TERRITORIO:ES704|35003|35007|35014|35015|35017|35030|ES705|35001|35002|35005|35006|35008|35009|35011|35012|35013|35016|35019|35020|35021|35022|35023|35025|35026|35027|35031|35032|35033|ES708|35004|35010|35018|35024|35028|35029|35034|ES703|38013|38048|ES706|38002|38003|38021|38036|38049|38050|ES707|38007|38008|38009|38014|38016|38024|38027|38029|38030|38033|38037|38045|38047|38053|ES709|38001|38004|38005|38006|38010|38011|38012|38015|38017|38018|38019|38020|38022|38023|38025|38026|38028|38031|38032|38034|38035|38038|38039|38040|38041|38042|38043|38044|38046|38051|38052&lang=es
...
if(params$año %in% c("2019_ABRIL", 2015, 2000)){
      ...
      for(i in 1:data_senado[["metadata"]][["dimensions"]][["dimension"]][["dimensionValues"]][["total"]][3]) {
        ...
        if(params$año == 2011){
          ...
          for(i in 1:data_senado[["metadata"]][["dimensions"]][["dimension"]][["dimensionValues"]][["total"]][2]) {
            ...
            if(params$año %in% c("2019_NOVIEMBRE", 2004)){
              df_senado <- data.frame(
                medida = rep(data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[1]][["code"]],
                             each = length(data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[2]][["code"]]) *
                                    length(data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[3]][["code"]])),
                candidatura = rep(data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[2]][["code"]],
                                  each = length(data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[3]][["code"]])),
                mun = data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[3]][["code"]],
                valor = c(unlist(strsplit(data_senado[["data"]][["observations"]], split = " | ", fixed = TRUE)), rep(NA, dR)))
              ...
              for(i in 1:data_senado[["metadata"]][["dimensions"]][["dimension"]][["dimensionValues"]][["total"]][2]) {
                ...
                if(params$año == 2008){
                  df_senado <- data.frame(
                    candidatura = rep(data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[1]][["code"]],
                                      each = length(data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[2]][["code"]]) *
                                             length(data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[3]][["code"]])),
                    mun = rep(data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[2]][["code"]],
                              each = length(data_senado[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[3]][["code"]])),
                  ...
                  df_partido <- data.frame(
                    candidatura = data_senado[["metadata"]][["dimensions"]][["dimension"]][["dimensionValues"]][["value"]][[1]][["id"]],
                    name_partido = vector(mode = "character", length = data_senado[["metadata"]][["dimensions"]][["dimension"]][["dimensionValues"]][["total"]][1]))
                  for(i in 1:data_senado[["metadata"]][["dimensions"]][["dimension"]][["dimensionValues"]][["total"]][1]) {
                    df_partido$name_partido[i] <- data_senado[["metadata"]][["dimensions"]][["dimension"]][["dimensionValues"]][["value"]][[1]][["name"]][["text"]][[i]][["value"]]
                  }
                }
              }
          }

...
convocatoria_senado <- convocatoria %>% 
  ...
  transform(url = paste0("url.", tolower(substring(code, 0,11)), tolower(substring(code, 13,13))))
convocatoria_senado <- convocatoria_senado %>% 
  mutate(order = as.integer(order(1:nrow(convocatoria_senado), decreasing = TRUE)),
         convocatoria_formatted = trimws(paste0(substring(code, 13,13), tolower(substring(code, 14,24)), " ", substring(code, 8,11))),
         convocatoria_axis = trimws(paste0(tolower(substring(code, 13,15)), " ", substring(code, 8,11))))
...
convocatoria_actual <- convocatoria_senado %>% filter(substring(code, 8,21) == params$año)
...
if(params$año %in% c("2019_NOVIEMBRE", "2019_ABRIL", 2016, 2008, 2004, 2000)){

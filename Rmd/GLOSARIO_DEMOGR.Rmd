...
<div class="row highlight card-columns">
  ...
  `r get_indicator_met_("Tasa de variación", "Incremento o disminución en el número de individuos pertenecientes a un determinado ámbito en un periodo concreto por cada 1.000 habitantes.")`</div>
</div>

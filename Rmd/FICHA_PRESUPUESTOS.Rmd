...
if(Variacion_Porcentual == "NA" & GAP == "NA"){
    cat(paste0(
      "<div class='column-2-ind'>", get_indicator2('Ingresos<br>por habitante', paste0(Num_Ingresos_hab, '€'), './img/ingresos-blue.png'), "</div><div class='column-2-ind'>", get_indicator2('Gastos<br>por habitante', paste0(Num_Gastos_hab, '€'), './img/gastos-blue.png'), "</div>"))
    }else{
      if(Variacion_Porcentual == "NA" & GAP != "NA"){
        cat(paste0(

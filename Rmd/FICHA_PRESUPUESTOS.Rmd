...
params:
  ...
  url.partida_codes: https://datos.canarias.es/api/estadisticas/structural-resources/v1.0/codelists/ISTAC/CL_PPTOS_ES_EELL_ESTRUCTURA_ECONOMICA/~latest/codes?limit=100000
  url.partida_codes_: https://datos.canarias.es/api/estadisticas/structural-resources/v1.0/codelists/ISTAC/CL_PPTOS_ES_EELL_ESTRUCTURA_ECONOMICA/~latest/codes
output:
  html_document:
    df_print: paged
...
url_partidas <- paste0(params$url.partida_codes_, "/", df_estr_partidas_mun$id_partida)

  ...
  mutate(
    tooltip = ifelse(
      ...
      ifelse(
        ...
        sprintf(leyenda.content_I, Municipio, Valor_inicial_l, Valor_l, Tasa_l),
        sprintf(leyenda.content, Municipio, Valor_l, Tasa_l)
        ),
      ifelse(
        Municipio == municipio_actual$municipio,
        sprintf(leyenda.content_I, Municipio, paste0(Valor_inicial_l, ' (',Año,')'), Valor_l, Tasa_l),
...
df_part_gastos_mun <- df_part_gastos_mun %>% transform(hovertext = paste0(
    ...
    "<br>Canarias: ", format(valor_Canarias, big.mark = ".", decimal.mark = ",", nsmall = 0), "€",

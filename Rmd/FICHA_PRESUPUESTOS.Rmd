    ...
    cat(paste0(
      ...
      if(Variacion_Porcentual_Presupuesto == "NA" & GAP != "NA"){
        cat(paste0(
          ...
          if(Variacion_Porcentual_Presupuesto != "NA" & GAP == "NA"){
            cat(paste0(
              "<div class='column-3'>", get_indicator2('Tasa de</br>variación', paste0(Variacion_Porcentual_Presupuesto, '%'), Imagen_Variacion), "</div><div class='column-3'>", get_indicator2('Ingresos<br>por habitante', paste0(Num_Ingresos_hab, '€'), './img/ingresos.png'), "</div><div class='column-3'>", get_indicator2('Gastos<br>por habitante', paste0(Num_Gastos_hab, '€'), './img/gastos.png'), "</div>"))
          }else{
            cat(paste0(
              "<div class='column-4'>", get_indicator2('Tasa de</br>variación', paste0(Variacion_Porcentual_Presupuesto, '%'), Imagen_Variacion), "</div><div class='column-4'>", get_indicator2('Ingresos<br>por habitante', paste0(Num_Ingresos_hab, '€'), './img/ingresos.png'), "</div><div class='column-4'>", get_indicator2('Gastos<br>por habitante', paste0(Num_Gastos_hab, '€'), './img/gastos.png'), "</div><div class='column-4'>", get_indicator2('Inicial vs<br>Ejecutado', paste0(GAP, ' mill.€'), './img/equilibrio-presupuestario.png'), "</div>"))
          }
        }
    }
```

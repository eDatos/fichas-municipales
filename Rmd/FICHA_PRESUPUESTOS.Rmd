...
d <- length(rep(data_ind_presupuestos[["data"]][["dimensions"]][["dimension"]][["representations"]][["representation"]][[1]][["code"]],
...
###### Añadir aviso si la variable d es mayor que 0 ######
...
df_presupuestos <- data.frame(
  ...
  valor = c(unlist(strsplit(data_ind_presupuestos[["data"]][["observations"]], split = " | ", fixed = TRUE)), rep(NA, d)))

...
df_estr_partidas_mun <- df_estr_partidas %>% filter(id_municipio == params$id_municipio & id_partida %notin% c("GASTOS", "INGRESOS")) %>% select(!id_municipio)
...
df_ep_total <- df_estr_partidas %>% filter(id_municipio == params$id_municipio & id_partida %in% c("GASTOS", "INGRESOS"))

...
año_max <- max(substring(df_u$periodo, 0,4)) %>% as.numeric
año_min <- min(substring(df_u$periodo, 0,4)) %>% as.numeric
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/collection.html?resourceType=collection&agencyId=ISTAC&resourceId=E59021A_000001",
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=PARO_REGISTRADO#visualization/table",
        "Paro registrado"
        )`
...
<h2 style="color: #005980; margin: 0;">`r Num_Paro` personas en paro</h2>
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=PARO_REGISTRADO_MUJERES#visualization/table",
        "Paro registrado. Mujeres")`
  `r get_indicator_mod_last(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=PARO_REGISTRADO_HOMBRES#visualization/table",
...
<div class="row">
  `r get_indicator_mod_first(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=E59021A_000008&version=~latest#visualization/table",
        "Paro registrado según sexos y grupos de edad")`
  `r get_indicator_mod_last(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=E59021A_000009&version=~latest#visualization/table",
        "Paro registrado según sexos y sectores económicos")`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=E59021A_000013&version=~latest#visualization/table",
        "Paro registrado según sexos y niveles de estudios"
        )`

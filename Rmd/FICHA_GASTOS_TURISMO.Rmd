...
if(Variacion_Porcentual_GM == "NA"){
  ...
  cat(paste0(
    '<div class="column-3">', get_indicator2("Tasa de</br>variación interanual", paste0(Variacion_Porcentual_GM, "%"), Imagen_Variacion), '</div><div class="column-3">', get_indicator2("Mujeres", paste0(Gasto_por_turista_M, " €"), "./img/female.png"), '</div><div class="column-3">', get_indicator2("Hombres", paste0(Gasto_por_turista_H, " €"), "./img/male.png"), '</div>'))
}
```
</div>

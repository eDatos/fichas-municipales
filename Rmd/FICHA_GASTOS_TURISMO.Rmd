...
Variacion_Porcentual <- ind_GM %>% filter(mun == params$id_municipio & code == periodo_actual$code) %>% select(tasa) %>% as.numeric() %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)

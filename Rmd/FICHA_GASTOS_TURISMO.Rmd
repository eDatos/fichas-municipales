...
# GM_Canarias <- df_u %>% filter(Municipio == "ES70" & Periodo == periodo_actual$code) %>% select(Valor) %>% as.numeric()
# GM_Isla <- df_u %>% filter(Municipio == municipio_actual$id_isla & Periodo == periodo_actual$code) %>% select(Valor) %>% as.numeric()
...
df_GM_np_plot <- df_GM_np_mun %>%
  mutate(label = "|")
# df_GM_np_plot$noches <- ordered(df_GM_np_plot$noches, levels = df_GM_np_plot$noches)
...
<div class='progress-bar-8' style="padding-left: 6px; margin-top: -5px; color: #59656E; font-weight: 600;">|</div><div class='sp-content'>Canarias</div></div>
</div>
...
<div class="column highlight" style="width: 100% !important; margin-top: -30px;">
  ...
  <div class='progressbar-legend'><div class='progress-bar-1' style='font-size: 11px;'></div><div class='sp-content'>`r df_GM_ne_plot$estudios[3]`</div></div>
  ...
  <div class='progressbar-legend'><div class='progress-bar-3' style='font-size: 11px;'></div><div class='sp-content'>`r df_GM_ne_plot$estudios[1]`</div></div>
  <div class='progressbar-legend'>
  <div class='progress-bar-8' style="padding-left: 6px; color: #59656E; font-weight: 600; font-size: 11px;">|</div><div class='sp-content'>Canarias</div></div>
  </div>
</div>
</div>
<div class="column-3">
...
<div class="column highlight" style="width: 100% !important; margin-top: -30px;">
  ...
  <div class="legend-vertical-container">
  <div class='progressbar-legend'><div class='progress-bar-1' style='font-size: 11px;'></div><div class='sp-content'>`r df_GM_np_plot$noches[3]`</div></div>
  ...
  <div class='progressbar-legend'><div class='progress-bar-3' style='font-size: 11px;'></div><div class='sp-content'>`r df_GM_np_plot$noches[1]`</div></div>
  <div class='progressbar-legend'>
  <div class='progress-bar-8' style="padding-left: 6px; color: #59656E; font-weight: 600;font-size: 11px;">|</div><div class='sp-content'>Canarias</div></div>
  </div>
</div>

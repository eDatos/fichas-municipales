...
# df_GMd_pais_mun$pais <- ordered(df_GMd_pais_mun$pais, levels = df_GMd_pais_mun$pais[4:1])

df_GMd_pais_mun <- df_GMd_pais_mun %>% transform(hovertext = paste0(
    "<b>", pais, "</b>",
    "<br>",trimws(format(valor, big.mark = ".", decimal.mark = ",")), " €", 
    "<br>Canarias: ", format(valor_Canarias, big.mark = ".", decimal.mark = ","), " €"
    )
...
if(Variacion_Porcentual_GM == "NA"){
  ...
  cat(paste0(
    '<div class="column-3">', get_indicator2("Tasa de</br>variación", paste0(Variacion_Porcentual_GM, "%"), Imagen_Variacion), '</div><div class="column-3">', get_indicator2("Mujeres", paste0(Gasto_por_turista_d_M, " €"), "./img/female.png"), '</div><div class="column-3">', get_indicator2("Hombres", paste0(Gasto_por_turista_d_H, " €"), "./img/male.png"), '</div>'))
}
```
</div>
...
<div class="row highlight" style="width: 100% !important; padding-bottom: -10px; margin-bottom: -8px;">
...
<div class="row highlight" style="width: 100% !important; padding: 0;">
...
<div class="column highlight" style="width: 100% !important; padding: 9px;">
  <div class="piramide" style="height: 152px;">
  `r g_GMd_ne`
  </div>
  <div class="legend-vertical-container">
  <div class='progressbar-legend'><div class='progress-bar-1'></div><div class='sp-content'>`r df_GMd_ne_plot$estudios[3]`</div></div>
  <div class='progressbar-legend'><div class='progress-bar-2'></div><div class='sp-content'>`r df_GMd_ne_plot$estudios[2]`</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3'></div><div class='sp-content'>`r df_GMd_ne_plot$estudios[1]`</div></div>
  <div class='progressbar-legend'>
  <div class='progress-bar-8' style="padding-left: 6px; margin-top: -1px; color: #59656E; font-weight: 600;">|</div><div class='sp-content'>Canarias</div></div>
  </div>
</div>
</div>
</div>
...
<div class="column highlight" style="width: 100% !important; padding: 9px;">
  ...
  <div class="legend-vertical-container">
  <div class='progressbar-legend'><div class='progress-bar-1'></div><div class='sp-content'>`r df_GMd_np_plot$noches[3]`</div></div>
  <div class='progressbar-legend'><div class='progress-bar-2'></div><div class='sp-content'>`r df_GMd_np_plot$noches[2]`</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3'></div><div class='sp-content'>`r df_GMd_np_plot$noches[1]`</div></div>
  <div class='progressbar-legend'>
  <div class='progress-bar-8' style="padding-left: 6px; margin-top: -1px; color: #59656E; font-weight: 600;">|</div><div class='sp-content'>Canarias</div></div>
  </div>
</div>

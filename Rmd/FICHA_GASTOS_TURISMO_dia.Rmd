...
df_GMd_ne_plot <- df_GMd_ne_plot %>% mutate(estudios = recode(estudios, "Sin estudios o primarios" = "Sin estudios<br>o primarios"))
...
<div class="row">
<div class="column highlight" style="margin-bottom: -9px;">
<div class="row" style="margin-top: 10px">

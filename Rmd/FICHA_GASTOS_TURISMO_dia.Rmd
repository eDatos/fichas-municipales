...
Num_GM <- Num_GM_num %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
...
Gasto_por_turista_dia <- df_GM_mun$valor[which(df_GM_mun$ind == "Gasto por turista y día")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)

df_GMd_sexo_mun <- ind_GM_sexo_edad %>%
  filter(ind == "Gasto por turista y día" & sexo != "AMBOS SEXOS" & gredad == "TOTAL GRUPOS DE EDADES") %>% 
  select(c(sexo, valor))

Gasto_por_turista_d_M <- df_GMd_sexo_mun$valor[which(df_GMd_sexo_mun$sexo == "Mujeres")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
Gasto_por_turista_d_H <- df_GMd_sexo_mun$valor[which(df_GMd_sexo_mun$sexo == "Hombres")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)

df_GMd_edad_mun <- ind_GM_sexo_edad %>%
  filter(ind == "Gasto por turista y día" & sexo == "AMBOS SEXOS" & gredad != "TOTAL GRUPOS DE EDADES") %>% 
  select(c(gredad, valor))

Gasto_por_turista_d_menor <- df_GMd_edad_mun$valor[which(df_GMd_edad_mun$gredad == "De 16 a 44 años")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
Gasto_por_turista_d_mayor <- df_GMd_edad_mun$valor[which(df_GMd_edad_mun$gredad == "Mayor de 44 años")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
...
Gasto_por_turista_d_menor_C <- df_GM_sexo_edad_C$valor[which(df_GM_sexo_edad_C$gredad == "De 16 a 44 años")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
Gasto_por_turista_d_mayor_C <- df_GM_sexo_edad_C$valor[which(df_GM_sexo_edad_C$gredad == "Mayor de 44 años")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
```
...
Gasto_tur_sl_d_Act <- df_GMd_sl_mun$valor[which(df_GMd_sl_mun$sl == "Activos")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
Gasto_tur_sl_d_NAct <- df_GMd_sl_mun$valor[which(df_GMd_sl_mun$sl == "Inactivos")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)

df_GMd_sl_C <- df_GM_sl %>%
  filter(ind == "Gasto por turista y día" & sl != "TOTAL" & mun == "CANARIAS" & periodo == periodo_actual$code) %>% 
  select(c(sl, valor))

Gasto_tur_sl_d_Act_C <- df_GMd_sl_C$valor[which(df_GMd_sl_C$sl == "Activos")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
Gasto_tur_sl_d_NAct_C <- df_GMd_sl_C$valor[which(df_GMd_sl_C$sl == "Inactivos")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
```
...
df_GMd_ne_mun$estudios <- ordered(df_GMd_ne_mun$estudios, levels = df_GMd_ne_mun$estudios[4:1])

df_GMd_ne_mun <- df_GMd_ne_mun %>% transform(hovertext = paste0(
    "<b>", estudios, "</b>",
    "<br>",trimws(format(valor, big.mark = ".", decimal.mark = ",")), " €", 
    "<br>Canarias: ", format(valor_Canarias, big.mark = ".", decimal.mark = ","), " €"
    )
...
df_GMd_ne_plot <- df_GMd_ne_mun %>%
  mutate(label = "|")
df_GMd_ne_plot$estudios <- ordered(df_GMd_ne_plot$estudios, levels = df_GMd_ne_plot$estudios[4:1])
...
Gasto_tur_ta_d_hot <- df_GMd_ta_mun$valor[which(df_GMd_ta_mun$tipo == "Hoteleros")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
Gasto_tur_ta_d_ext <- df_GMd_ta_mun$valor[which(df_GMd_ta_mun$tipo == "Extrahoteleros")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
Gasto_tur_ta_d_otr <- df_GMd_ta_mun$valor[which(df_GMd_ta_mun$tipo == "Otros alojamientos colectivos")] %>% round(1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
```
...
df_GMd_np_mun$noches <- ordered(df_GMd_np_mun$noches, levels = df_GMd_np_mun$noches[4:1])

df_GMd_np_mun <- df_GMd_np_mun %>% transform(hovertext = paste0(
    "<b>", noches, "</b>",
    "<br>",trimws(format(valor, big.mark = ".", decimal.mark = ",")), " €", 
    "<br>Canarias: ", format(valor_Canarias, big.mark = ".", decimal.mark = ","), " €"
    )
...
df_GMd_np_plot <- df_GMd_np_mun %>%
  mutate(label = "|")
df_GMd_np_plot$noches <- ordered(df_GMd_np_plot$noches, levels = df_GMd_np_plot$noches[4:1])
...
df_GM_pais_d_mun <- df_GM_pais %>%
  filter(ind != "Gasto por turista y día"  & pais != "TOTAL" & mun == municipio_actual$municipio & periodo == periodo_actual$code) %>%
  select(c(pais, valor))
df_GM_pais_d_Canarias <- df_GM_pais %>%
  filter(ind != "Gasto por turista y día" & pais != "TOTAL" & mun == "CANARIAS" & periodo == periodo_actual$code) %>%
  select(c(pais, valor))
df_GM_pais_d_mun <- df_GM_pais_d_mun %>% mutate(valor_Canarias = df_GM_pais_d_Canarias$valor)
df_GM_pais_d_mun$pais <- ordered(df_GM_pais_d_mun$pais, levels = df_GM_pais_d_mun$pais[4:1])

df_GM_pais_d_mun <- df_GM_pais_d_mun %>% transform(hovertext = paste0(
    "<b>", pais, "</b>",
    "<br>",trimws(format(valor, big.mark = ".", decimal.mark = ",")), " €", 
    "<br>Canarias: ", format(valor_Canarias, big.mark = ".", decimal.mark = ","), " €"
    )
...
df_GMd_pais_plot <- df_GM_pais_d_mun %>%
  mutate(valor_Canarias = df_GM_pais_d_Canarias$valor,
         label = "|")
df_GMd_pais_plot$pais <- ordered(df_GMd_pais_plot$pais, levels = df_GMd_pais_plot$pais[4:1])
...
g_GM_pais_d <- ggplot(df_GMd_pais_plot, aes(y = pais, fill = pais, label = label, name = NULL, text = hovertext)) +
  geom_bar(stat = "identity", alpha = 0.8, width = 0.4, aes(x = valor)) +
  geom_text(size = 6, color = "#59656E", aes(x = valor_Canarias, text = "")) +
...
g_GM_pais_d <- ggplotly(g_GM_pais_d, tooltip = c("text")) %>%
  layout(hoverlabel = "", hovermode = 'y unified') %>%
  config(displaylogo = FALSE, modeBarButtons = list(list("zoom2d"),list("pan2d"),list("resetScale2d"),list("toImage"))) %>%
  style(hoverinfo = "skip", traces = c(5:8))
```
...
<h2 style="color: #005980; margin-bottom: 0;">`r Gasto_por_turista_dia` €</h2>
<div class="linechart">
  `r g_line`
</div>
...
if(Variacion_Porcentual_GM == "NA"){
  cat(paste0(
    '<div class="column-2">', get_indicator2("Mujeres", paste0(Gasto_por_turista_d_M, " €"), "./img/female.png"), '</div><div class="column-2">', get_indicator2("Hombres", paste0(Gasto_por_turista_d_H, " €"), "./img/male.png"), '</div>'))
}else{
  cat(paste0(
    '<div class="column-3">', get_indicator2("Tasa de</br>...", paste0(Variacion_Porcentual_GM, "%"), Imagen_Variacion), '</div><div class="column-3">', get_indicator2("Mujeres", paste0(Gasto_por_turista_d_M, " €"), "./img/female.png"), '</div><div class="column-3">', get_indicator2("Hombres", paste0(Gasto_por_turista_d_H, " €"), "./img/male.png"), '</div>'))
}
```
</div>
...
<div class="row highlight" style="width: 100% !important; padding: 6px;">
...
<div class="indicator-map">
  ...
  <div class='progressbar-legend'><div class='progress-bar-1'></div><div class='sp-content'>`r df_GMd_ne_plot$estudios[1]`</div></div>
  <div class='progressbar-legend'><div class='progress-bar-2'></div><div class='sp-content'>`r df_GMd_ne_plot$estudios[2]`</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3'></div><div class='sp-content'>`r df_GMd_ne_plot$estudios[3]`</div></div>
  <div class='progressbar-legend'>
  <div class='progress-bar-8' style="padding-left: 6px; margin-top: 0; color: #59656E; font-weight: 600;">|</div><div class='sp-content'>Canarias</div></div>
  </div>
</div>
...
<div class="indicator-map">
  ...
  <div class="legend-vertical-container">
  <div class='progressbar-legend'><div class='progress-bar-1'></div><div class='sp-content'>`r df_GMd_np_plot$noches[1]`</div></div>
  <div class='progressbar-legend'><div class='progress-bar-2'></div><div class='sp-content'>`r df_GMd_np_plot$noches[2]`</div></div>
  <div class='progressbar-legend'><div class='progress-bar-3'></div><div class='sp-content'>`r df_GMd_np_plot$noches[3]`</div></div>
  <div class='progressbar-legend'>
  <div class='progress-bar-8' style="padding-left: 6px; margin-top: 0; color: #59656E; font-weight: 600;">|</div><div class='sp-content'>Canarias</div></div>
  </div>
</div>
...
<div class="row highlight">
  ...
  <div style="padding: 0 10px;">`r get_indicator_met_("Gasto medio diario por persona", "Gasto que resulta al dividir el gasto total entre el número de pernoctaciones del viaje.")`</div>

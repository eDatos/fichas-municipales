...
df_GM_ne$estudios <- factor(df_GM_ne$estudios, levels=GM_ne[["categories"]][["codes"]][[2]], labels=c("TOTAL", "Sin estudios<br>o primarios", "Secundarios", "Superiores"))
...
<div class="indicator-title" style="width: 100% !important;">
  <h3>Niveles educativos</h3>
</div>
<div class="column highlight" style="width: 100% !important; padding: 30px 10px 5px;">

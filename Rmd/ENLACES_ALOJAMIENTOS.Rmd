...
df_viajeros <- data.frame(
  ...
  valor = unlist(strsplit(viajeros_lugar[["data"]][["observations"]], split = " | ", fixed = TRUE)))
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/collection.html?resourceType=collection&agencyId=ISTAC&resourceId=C00065A_000001",
        "Encuesta de Alojamiento Turístico Colectivo")`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=C00065A_000036&version=~latest#visualization/table",
        "Pernoctaciones, viajeros alojados y entrados y estancia media según principales nacionalidades")`
  `r get_indicator_mod_inter(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=ALOJATUR_PLAZAS_OCUPACION#visualization/table",
        "Tasa de ocupación por plazas")`
  `r get_indicator_mod_last(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=indicator&resourceId=ALOJATUR_TARIFA_ADR#visualization/table",
        "Tarifa media diaria (ADR)")`

<div class="column-modulo-right">
<div class="highlight-modulo">
<div class="linechart-placeholder" style="margin-bottom: 15px;">
<h2 style="color: #005980; margin: 0;">`r num_viajeros` personas alojadas</h2>
<div class="linechart">
  `r g_line`
</div>
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=C00065A_000001&version=~latest#visualization/table",
        "Establecimientos abiertos, plazas, habitaciones ofertadas y tasas de ocupación de hoteles")`
  `r get_indicator_mod_last(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=C00065A_000002&version=~latest#visualization/table",
        "Establecimientos abiertos, plazas, apartamentos ofertados y tasas de ocupación de apartamentos")`
...
<div class="row" style="margin-top: 10px;">
  `r get_indicator_mod_first(
        ...
        "Pernoctaciones, viajeros alojados y entrados y estancia media según principales nacionalidades")`
  `r get_indicator_mod_last(
        "https://www3.gobiernodecanarias.org/istac/statistical-visualizer/visualizer/data.html?resourceType=dataset&agencyId=ISTAC&resourceId=C00065A_000037&version=~latest#visualization/table",
        "Pernoctaciones, viajeros españoles alojados, viajeros españoles entrados y estancia media según principales lugares de residencia")`

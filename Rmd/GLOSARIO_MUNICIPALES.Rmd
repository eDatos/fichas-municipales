...
<div class="row highlight card-columns-3">
  ...
  `r get_indicator_met_("Electores", "Personas que reúnen los requisitos para votar y no están privadas definitiva o temporalmente del derecho de sufragio. El total de estas personas constituye el censo electoral. Este está compuesto por el censo de electores residentes en España (CER) y en determinadas elecciones, por el censo de electores residentes ausentes que viven en el extranjero (CERA) y/o por el censo de personas extranjeras que residen en España (CERE).")`
  `r get_indicator_met_("Ratio de votos a candidatura", "Porcentaje de votos que recibe una determinada candidatura sobre el total de los votos válidos emitidos a candidaturas.")`
  `r get_indicator_met_("Representantes elegidos", "Número de representantes de la candidatura que resultaron electos.")`
  `r get_indicator_met_("Tasa de abstención", "Porcentaje de electores que no ejercen su derecho al voto (electores abstenidos) sobre el total de electores.")`
  `r get_indicator_met_("Tasa de participación", "Porcentaje de electores que ejercen su derecho al voto (electores votantes) sobre el total de electores.")`
  `r get_indicator_met_("Variación", "Incremento o disminución de la tasa de participación pertenecientes a un determinado ámbito en un periodo concreto medido por puntos.")`

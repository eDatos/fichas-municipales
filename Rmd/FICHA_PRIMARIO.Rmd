...
percent_herbaceos <- round(sup_herbaceos / superficie_cultivada_num * 100, 1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
...
percent_leñosos <- round(sup_leñosos / superficie_cultivada_num * 100, 1) %>% format(big.mark = ".", decimal.mark = ",", nsmall = 1)
...
order_especies <- c("Conejos","Gallinas", "Abejas", "Porcinos", "Ovinos", "Caprinos", "Bovinos")
...
#   cat(paste0(
#     "<div class='column-3-ind'>", get_indicator2(paste0('Secano</br></p><p class="label" style="color: #999;">', paste0(percent_secano, '%')), paste0(sup_secano, " ha"), './img/secano.png'), "</div><div class='column-3-ind'>", get_indicator2(paste0('Regadío</br></p><p class="label" style="color: #999;">', paste0(percent_regadio, '%')), paste0(sup_regadio, " ha"), './img/regadio.png'), "</div><div class='column-3-ind'>", get_indicator2("<br>", 0, "./img/percent-blue.png"), "</div>"))
# }else{
#   cat(paste0(
#     "<div class='column-4'>", get_indicator2('Tasa de</br>variación', paste0(Variacion_Porcentual, '%'), Imagen_Variacion), "</div><div class='column-4'>", get_indicator2(paste0('Secano</br></p><p class="label" style="color: #999;">', paste0(percent_secano, '%')), paste0(sup_secano, " ha"), './img/secano.png'), "</div><div class='column-4'>", get_indicator2(paste0('Regadío</br></p><p class="label" style="color: #999;">', paste0(percent_regadio, '%')), paste0(sup_regadio, " ha"), './img/regadio.png'), "</div><div class='column-4'>", get_indicator2("<br>", 0, "./img/percent-blue.png"), "</div>"))
# }
cat(paste0(
    "<div class='column-3-ind'>", get_indicator2('Tasa de</br>variación', paste0(Variacion_Porcentual, '%'), Imagen_Variacion), "</div><div class='column-3-ind'>", get_indicator2(paste0('Secano</br></p><p class="label" style="color: #999;">', paste0(percent_secano, '%')), paste0(sup_secano, " ha"), './img/secano_.png'), "</div><div class='column-3-ind'>", get_indicator2(paste0('Regadío</br></p><p class="label" style="color: #999;">', paste0(percent_regadio, '%')), paste0(sup_regadio, " ha"), './img/regadio.png'), "</div>"))
if(Variacion_Porcentual == "NA"){
  cat(paste0(
...
<div class="column highlight">
  <div class="row">
  <div class="column-2">`r get_indicator4s("Total", paste0(sup_herbaceos_C, "ha"), paste0(sup_herbaceos, "ha"))`</div>
  <div class="column-2">`r get_indicator4s("Porcentaje", paste0(percent_herbaceos_C, "%"), paste0(percent_herbaceos, "%"))`</div>
  </div>
<div class="column highlight" style="padding: 10px 0 20px;">
<div class="row">
<div class='indicator5'><div class='indicator-content'><p class='value'>`r sup_herbaceos_num` ha</p><hr class='separator'><p class='label'>Superficie cultivada</p></div></div>
</div>
...
<div class="column highlight">
  <div class="row">
  <div class="column-2">`r get_indicator4s("Total", paste0(sup_leñosos_C, "ha"), paste0(sup_leñosos, "ha"))`</div>
  <div class="column-2">`r get_indicator4s("Porcentaje", paste0(percent_leñosos_C, "%"), paste0(percent_herbaceos, "%"))`</div>
<div class="row">
<div class='indicator5'><div class='indicator-content'><p class='value'>`r sup_leñosos_num` ha</p><hr class='separator'><p class='label'>Superficie cultivada</p></div></div>
</div>
<div class="piramide" style="height: 300px">
  `r g_leñosos`
</div>
...
<div class="row">
<div class="column highlight" style="padding: 26px 0 8px;">
  <h3>Número de cabezas/Colmenas</h3>
</div>
</div>
...
<div class="column highlight" style="padding: 16px 0;">
...
<div class="row">
  <div class="column-3-ind" style="height: 50px;">`r get_indicator3("Abejas", colmenas_num, "./img/abeja_.png")`</div>
  <div class="column-3-ind" style="height: 50px;">`r get_indicator3("Gallinas", gallinas_num, "./img/gallina_.png")`</div>
  <div class="column-3-ind" style="height: 50px;">`r get_indicator3("Conejos", conejos_num, "./img/conejo_.png")`</div>
<div class="column highlight" style="padding: 13px 0;">
<div class="row">

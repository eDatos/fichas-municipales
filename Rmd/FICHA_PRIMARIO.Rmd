...
df_herbaceos_mun <- df_herbaceos_mun %>%
  # mutate(porcentaje = df_herbaceos_mun$valor / sum(df_herbaceos_mun$valor) * 100,
  mutate(porcentaje = df_herbaceos_mun$valor / sup_herbaceos_num * 100,
         ...
         # porcentaje_Canarias = df_herbaceos_C$valor / sum(df_herbaceos_C$valor) * 100)
...
df_leñosos_mun <- df_leñosos_mun %>%
  # mutate(porcentaje = df_leñosos_mun$valor / sum(df_leñosos_mun$valor) * 100,
  mutate(porcentaje = df_leñosos_mun$valor / sup_leñosos_num * 100,
         ...
         # porcentaje_Canarias = df_leñosos_C$valor / sum(df_leñosos_C$valor) * 100)
...
<div class="row">
<div class="column highlight" style="padding-top: 20px;">
<div class="piramide" style="height: 240px">
  `r g_exp_especies`
</div>
...
<div class="row">
  ...
  <div class="column-3-ind" style="height: 50px;">`r get_indicator3("Abejas", abejas_num, "./img/abeja.png")`</div>
  <div class="column-3-ind" style="height: 50px;">`r get_indicator3("Conejos", conejos_num, "./img/conejo.png")`</div>
</div>
</div>

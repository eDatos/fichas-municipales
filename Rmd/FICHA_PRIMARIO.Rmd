...
<div class="row" style="margin-bottom: 30px;">
  <div class="column-3">`r get_indicator3("Bovinos", bovinos_num, "./img/bovino.png")`</div> 
  <div class="column-3">`r get_indicator3("Caprinos", caprinos_num, "./img/caprino.png")`</div> 
  <div class="column-3">`r get_indicator3("Ovinos", ovinos_num, "./img/ovino.png")`</div> 
</div>
<div class="row">
  <div class="column-2">`r get_indicator3("Porcinos", porcinos_num, "./img/porcino.png")`</div> 
  <div class="column-2">`r get_indicator3("Conejos", conejos_num, "./img/conejo.png")`</div> 
</div>

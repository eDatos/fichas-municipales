...
df_herbaceos_mun$cultivo <- ordered(df_herbaceos_mun$cultivo, levels = rk_herbaceos_mun$cultivo[8:1])
...
df_herbaceos_mun <- df_herbaceos_mun %>%
  transform(hovertext = paste0(
    "<b>", cultivo, "</b><br>",
    trimws(format(valor, big.mark = ".", decimal.mark = ",", nsmall = 1)), " ha")) %>%
  filter(valor != 0)

if(nrow(df_herbaceos_mun) == 8){
  col <- c("#D5EDFA", "#8CD2EA", "#2CBCE2", "#00A6DC", "#008BD0", "#0072A2", "#005980", "#00405B")
  }else if(nrow(df_herbaceos_mun) == 7){
    col <- c("#D5EDFA", "#8CD2EA", "#2CBCE2", "#00A6DC", "#008BD0", "#0072A2", "#005980")
    }else if(nrow(df_herbaceos_mun) == 6){
      col <- c("#8CD2EA", "#2CBCE2", "#00A6DC", "#008BD0", "#0072A2", "#005980")
      }else if(nrow(df_herbaceos_mun) == 5){
        col <- c("#8CD2EA", "#2CBCE2", "#008BD0", "#0072A2", "#005980")
        }else if(nrow(df_herbaceos_mun) == 4){
          col <- c("#8CD2EA", "#2CBCE2", "#008BD0", "#005980")
          }else if(nrow(df_herbaceos_mun) == 3){
            col <- c("#8CD2EA", "#008BD0", "#005980")
            }else if(nrow(df_herbaceos_mun) == 2){
              col <- c("#8CD2EA", "#005980")
            }

g_herbaceos <- ggplot(data = df_herbaceos_mun, aes(y = cultivo, fill = cultivo, name = NULL, text = hovertext)) +
  ...
  theme(axis.text.x = element_text(),
        ...
        legend.position = "none") +
  scale_x_continuous(labels = function(x){paste0(format(x, big.mark = '.', decimal.mark = ","), ' ha')}) +
  scale_y_discrete(labels = df_herbaceos_mun$name_cultivo[nrow(df_herbaceos_mun):1])
...
df_leñosos_mun$cultivo <- ordered(df_leñosos_mun$cultivo, levels = rk_leñosos_mun$cultivo[8:1])
...
if(nrow(df_leñosos_mun) == 8){
  col <- c("#D5EDFA", "#8CD2EA", "#2CBCE2", "#00A6DC", "#008BD0", "#0072A2", "#005980", "#00405B")
  }else if(nrow(df_leñosos_mun) == 7){
    col <- c("#D5EDFA", "#8CD2EA", "#2CBCE2", "#00A6DC", "#008BD0", "#0072A2", "#005980")
    }else if(nrow(df_leñosos_mun) == 6){
      col <- c("#8CD2EA", "#2CBCE2", "#00A6DC", "#008BD0", "#0072A2", "#005980")
      }else if(nrow(df_leñosos_mun) == 5){
        col <- c("#8CD2EA", "#2CBCE2", "#008BD0", "#0072A2", "#005980")
        }else if(nrow(df_leñosos_mun) == 4){
          col <- c("#8CD2EA", "#2CBCE2", "#008BD0", "#005980")
          }else if(nrow(df_leñosos_mun) == 3){
            col <- c("#8CD2EA", "#008BD0", "#005980")
            }else if(nrow(df_leñosos_mun) == 2){
              col <- c("#8CD2EA", "#005980")
            }

g_leñosos <- ggplot(data = df_leñosos_mun, aes(y = cultivo, fill = cultivo, name = NULL, text = hovertext)) +
  geom_bar(stat = "identity", alpha = 0.8, width = 0.6, aes(x = valor)) +
  theme_minimal() +
  labs(title = "", x = NULL, y = NULL, colour = " ") +
  guides(fill = FALSE) +
  ...
  theme(axis.text.x = element_text(),
        ...
        legend.position = "none") +
  scale_x_continuous(labels = function(x){paste0(format(x, big.mark = '.', decimal.mark = ","), ' ha')}) +
  scale_y_discrete(labels = df_leñosos_mun$name_cultivo[(nrow(df_leñosos_mun)):1])
...
df_exp_especies_mun$especie <- ordered(df_exp_especies_mun$especie, levels = order_especies)

df_exp_especies_mun <- df_exp_especies_mun %>% transform(hovertext = paste0(
  "<b>", trimws(especie), "</b><br>",
  trimws(format(valor, big.mark = ".", decimal.mark = ",")), " explotaciones"
  )
)

col <- c("#8CD2EA", "#2CBCE2", "#00A6DC", "#008BD0", "#0072A2", "#005980")

g_exp_especies <- ggplot(data = df_exp_especies_mun, aes(y = especie, fill = especie, name = NULL, text = hovertext)) +
  geom_bar(stat = "identity", alpha = 0.8, width = 0.6, aes(x = valor)) +
  theme_minimal() +
  labs(title = "", x = NULL, y = NULL, colour = " ") +
  guides(fill = FALSE) +
...
<div class="piramide" style="height: 195px">
  `r g_exp_especies`
</div>

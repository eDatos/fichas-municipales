...
<div class="row" style="margin-bottom: 30px;">
  <div class="column-2" style="height: 50px;">`r get_indicator3("Gallinas", gallinas_num, "./img/gallina.png")`</div>
  <div class="column-2" style="height: 50px;">`r get_indicator3("Colmenas", abejas_num, "./img/abeja.png")`</div>
</div>
<div class="row">
  <div style="height: 50px;">`r get_indicator3("Conejos", conejos_num, "./img/conejo.png")`</div>
</div>
</div>

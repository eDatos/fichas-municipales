...
df_secano <- recode_Frontera(df_secano)
...
df_regadio <- recode_Frontera(df_regadio)
...
df_exp_especies_ <- recode_Frontera(df_exp_especies_)
...
df_cab_especies <- recode_Frontera(df_cab_especies)
...
df_colmenas <- recode_Frontera(df_colmenas)
...
<h3 style="color: #999;margin: 0;float: right;margin-right: 20px;">`r params$ano`</h3>

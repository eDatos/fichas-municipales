...
<div class="row">
  `r get_indicator_mod("Indicador de la variable principal", "")`
...
<div class="row">
  `r get_indicator_mod("Gráfico espacio-temporal", "Gráfico comparativo del municipio con otros dos relacionados a lo largo del tiempo.")`
...
<div class="row">
  `r get_indicator_mod("Indicadores principales", "Tasa de variación y los indicadores más relevantes de cada ámbito.")`
...
<div class="row">
  `r get_indicator_mod("Rankings territoriales", "Clasificación del municipio en distintos territorios.</p>")`
...
<div class="row">
  `r get_indicator_mod("Otros indicadores", "Recuadros característicos de cada temática, con las representaciones gráficas adecuadas para cada desagregación que se tiene de los datos.")`
